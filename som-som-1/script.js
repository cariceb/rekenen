...
function GenereerProblem() {
    (Math.random() * 10);
opl_B2.value = Math.floor(Math.random() * 10)
opl_B3.value = Math.floor(Math.random() * 10)
opl_C2.value = Math.floor(Math.random() * 10)
opl_C3.value= Math.floor(Math.random() * 10)
